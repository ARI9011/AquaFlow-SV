...
export default function SobreNosotros() {
  ...
  const PILARES = [
    {
      icon: Cpu,
      title: 'Telemetría IoT en Vivo',
      desc: 'Medición continua de presión (PSI) y flujo (L/min) mediante microcontroladores Arduino conectados por streaming de datos en tiempo real (SSE).',
    ...
    },
    {
      ...
      desc: 'Canal directo para reportar fugas, cortes de agua e inestabilidad en el servicio con geolocalización y seguimiento administrativo.',
    ...
    },
    {
      ...
      desc: 'Integramos AquaBot potenciado por IA (Groq LLM) para brindar soporte 24/7 sobre el estado del suministro, consejos de ahorro y respuesta a consultas.',
    ...
    {
      icon: ShieldCheck,
      title: 'Transparencia y Accesibilidad',
      desc: 'Plataforma adaptada a altos estándares de accesibilidad (lectura por voz, modos de contraste) para garantizar un acceso inclusivo para todos los salvadoreños.',
    ...
    <div className="space-y-8 page-enter portal-grid-bg min-h-full pb-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          <div className="max-w-2xl space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-aqua-cyan/10 border border-aqua-cyan/20 text-aqua-cyan text-xs font-bold uppercase tracking-widest">
              <Sparkles size={13} /> Sobre Nosotros
            </div>
            
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight leading-tight gradient-text">
              Transformando el monitoreo hídrico en El Salvador
            </h1>
            
            <p className="text-gray-400 text-sm md:text-base leading-relaxed">
              <strong className="text-ink">AquaFlow SV</strong> es una plataforma tecnológica concebida para brindar supervisión en tiempo real, alertas preventivas y control inteligente del suministro de agua potable en los municipios del Gran San Salvador.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center p-6 bg-ink/[0.03] border border-ink/[0.08] rounded-3xl backdrop-blur-xl shadow-2xl flex-shrink-0 group hover:border-aqua-cyan/40 transition-all">
            ...
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Isotipo Oficial 2026</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="portal-card p-6 border-l-4 border-l-aqua-cyan space-y-3">
          ...
          <h3 className="text-xl font-black text-ink">Nuestra Misión</h3>
          <p className="text-xs text-gray-400 leading-relaxed font-medium">
            Proveer una plataforma integral de monitoreo hídrico que combine dispositivos IoT, mapas interactivos de geolocalización e inteligencia artificial para detectar desabastecimientos, fluctuaciones de presión y fugas, garantizando un servicio más transparente y eficiente para la comunidad salvadoreña.
          </p>
        </div>
        ...
        <div className="portal-card p-6 border-l-4 border-l-green-400 space-y-3">
          ...
          <h3 className="text-xl font-black text-ink">Nuestra Visión</h3>
          <p className="text-xs text-gray-400 leading-relaxed font-medium">
            Ser la solución de telemetría e infraestructura digital referente en El Salvador, empoderando a instituciones, técnicos y ciudadanos con información precisa para la toma de decisiones sostenibles en el cuidado y gestión del agua potable.
          </p>
        </div>
      </div>
      ...
      <div>
        <div className="text-center max-w-xl mx-auto mb-6">
          <p className="text-[10px] text-aqua-cyan/60 uppercase tracking-[0.25em] font-bold mb-1">Innovación Tecnológica</p>
          <h2 className="text-2xl font-black tracking-tight text-ink">Pilares Clave de AquaFlow SV</h2>
        </div>
      ...
      <div className="portal-card p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 pb-4 border-b border-ink/5">
          <div>
            <h3 className="text-lg font-black text-ink">Cobertura Actual en el Gran San Salvador</h3>
            <p className="text-xs text-gray-500">Zonas monitoreadas activamente por la red de sensores</p>
          </div>
          <div className="flex items-center gap-1.5 bg-green-500/10 border border-green-500/20 px-3 py-1 rounded-full text-green-400 text-xs font-bold">
            <Activity size={13} className="animate-pulse" /> Telemetría Activa
          </div>
        </div>
      ...
      <div>
        <div className="text-center max-w-xl mx-auto mb-6">
          <p className="text-[10px] text-aqua-cyan/60 uppercase tracking-[0.25em] font-bold mb-1">Talento y Compromiso</p>
          <h2 className="text-2xl font-black tracking-tight text-ink">Equipo de Desarrollo</h2>
          <p className="text-xs text-gray-500 mt-1">Estudiantes detrás de la creación de AquaFlow SV</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {TEAM.map((m) => (
            <div key={m.nombre} className="portal-card p-5 text-center flex flex-col items-center hover:scale-[1.02] transition-all duration-200 group">
              ...
              <p className="text-[10px] text-gray-500 font-medium mt-1">Desarrollador AquaFlow SV</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="portal-card p-6 text-center bg-gradient-to-r from-aqua-cyan/5 via-transparent to-aqua-cyan/5 border border-aqua-cyan/15">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="font-black text-ink text-sm">AquaFlow SV · Proyecto 2026</span>
        </div>
        <p className="text-xs text-gray-500 max-w-lg mx-auto">
          Diseñado con pasión por la innovación tecnológica, el compromiso ambiental y el bienestar de las familias salvadoreñas.
        </p>
      </div>
